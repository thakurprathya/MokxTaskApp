...
const ChatRoom = () =>{
    ...
    return (
        <div className="flex flex-col items-center bg-[#F8F8FF] min-h-[100vh]">
            ...
            <div className="flex items-center justify-between w-full bg-white p-5">
                <div className="flex items-center">
                    ...
                    <div className="flex flex-col gap-[6px] ml-[12px] md:ml-[20px]">
                        <p className="overflow-hidden font-raleway text-[#69235B] text-base not-italic font-medium leading-4">Arya</p>
                        <p className="overflow-hidden font-inter text-[#797C7B] text-xs not-italic font-thin leading-3">Vedic AI Bot</p>
                    </div>
                </div>
            ...
            {page===1 ? 
                <div className="mt-[25px] flex flex-col items-center w-[90%] mb-[180px]">
                    ...
                    <div className="self-start mt-[40px] flex flex-col items-center">
                        ...
                        <p className="overflow-hidden self-end md:self-auto md:ml-[170px] mt-[8px] font-inter text-[#797C7B] text-right text-[10px] not-italic font-thin leading-[10px]">09:25 AM</p>
                    </div>
                </div>
            : "" }
            ...
            {page===2 ? 
                <div className="mt-[25px] flex flex-col items-center w-[90%] mb-[180px]">
                    <p className="overflow-hidden font-raleway text-[#69235B] text-right text-xs not-italic font-medium leading-3">Today</p>
                    ...
                    <p className="overflow-hidden self-end mt-[8px] font-inter text-[#797C7B] text-right text-[10px] not-italic font-thin leading-[10px]">09:25 AM</p>
